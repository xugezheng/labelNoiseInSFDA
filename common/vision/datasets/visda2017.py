...
class VisDA2017(ImageList):
    ...
    image_list_imb = {
        "Tr": "image_list_imb/train_RS.txt",
        "Val": "image_list_imb/validation_UT.txt"
    }
    list_dict = {"image_list": image_list,
                 "image_list_imb": image_list_imb,
               
                 }
    CLASSES = ['aeroplane', 'bicycle', 'bus', 'car', 'horse', 'knife',
               'motorcycle', 'person', 'plant', 'skateboard', 'train', 'truck']

    def __init__(self, root: str, task: str, download: Optional[bool] = False, list_name = "image_list", **kwargs):
